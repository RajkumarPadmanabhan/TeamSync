...
def build_evaluation_matrix_pdf(filepath):
    ...
    matrix = [
        ...
        [Paragraph("6. User Experience", st['td']), Paragraph("10/10", st['td']), Paragraph("Dark Olive Green & Warm Cream design palette, Toast notifications, in-app warning confirmation dialogs, strikethrough completion UI", st['td']), Paragraph("globals.css, Toast.tsx", st['td'])],
